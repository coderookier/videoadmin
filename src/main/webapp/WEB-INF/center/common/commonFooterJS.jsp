...
<input type="hidden" id="apiServer" name="apiServer" value="http://121.248.54.185:6310"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://121.248.54.185:8080/mvc"/>
